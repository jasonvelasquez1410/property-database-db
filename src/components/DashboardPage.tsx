    ...
    <div className="bg-gray-50 pb-10">
      ...
      <main className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6 mt-8">
            <SummaryCard icon="properties" title="Total Properties" value={summaryStats.totalProperties.toString()} description="Active properties" trend="+3 this month" trendDirection="up" />
            <SummaryCard icon="chart-pie" title="Total Market Value" value={formatCurrency(summaryStats.totalValue)} description="Current portfolio value" trend="+5.2% from last quarter" trendDirection="up"/>
            <SummaryCard icon="exclamation-triangle" title="Needs Attention" value={summaryStats.needsAttention.toString()} description="Properties requiring action" trend="" trendDirection="none"/>
            <SummaryCard icon="calendar-days" title="Upcoming Payments" value={summaryStats.upcomingPayments.toString()} description="Due in next 30 days" trend="" trendDirection="none"/>
        </div>
