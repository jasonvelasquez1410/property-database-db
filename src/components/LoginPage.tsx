        ...
        <div className="w-full max-w-md bg-gray-900/80 rounded-2xl shadow-2xl p-8 space-y-8 text-white">
          <div className="text-center">
            <div className="flex justify-center mb-4">
              <img src="/svm-logo.jpg" alt="SVM Properties Logo" className="h-24 w-auto rounded-full object-cover border-4 border-white/20" />
            </div>
            <h2 className="text-3xl font-bold">SVM Properties Inc.</h2>
