            ...
            <div className="space-y-4">
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                 ...
                 <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
                    ...
                    <FormField label="Lot/Blk/Unit No." id="lotNo"><input id="lotNo" name="lotNo" type="text" value={propertyData.lotNo} onChange={handleChange} className="w-full border-gray-300 rounded-md shadow-sm" /></FormField>
