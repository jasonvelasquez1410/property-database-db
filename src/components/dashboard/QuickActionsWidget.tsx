...
export const QuickActionsWidget = ({ onAddProperty }: QuickActionsWidgetProps) => (
    <div className="bg-white rounded-xl shadow p-6">
        <h3 className="text-lg font-bold text-gray-900 mb-4">Quick Actions</h3>
        <div className="space-y-3">
            <button onClick={onAddProperty} className="w-full flex items-center gap-4 p-3 rounded-lg bg-gray-50 hover:bg-gray-100 transition-colors border">
             ...
             <button className="w-full flex items-center gap-4 p-3 rounded-lg bg-gray-50 hover:bg-gray-100 transition-colors border">
